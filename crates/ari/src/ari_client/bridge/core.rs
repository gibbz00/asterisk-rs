...
impl AriClient {
    pub async fn bridge_create(&self, _bridge_id: &BridgeId) -> AriClientResult<Bridge> {
        unimplemented!()
    }
    ...
    pub async fn bridge_destroy(&self, _bridge_id: &BridgeId) -> AriClientResult<()> {
        unimplemented!()
    }

    pub async fn bridge_add_channel(&self, _bridge_id: &BridgeId, _channel_id: &str) -> AriClientResult<()> {
        unimplemented!()
    }

    pub async fn bridge_remove_channel(&self, _bridge_id: &BridgeId, _channel_id: &str) -> AriClientResult<()> {
        unimplemented!()
    }
